...
module Readability
  class Document
    ...
    REGEXES = {
        ...
        :okMaybeItsACandidateRe => /and|article|storyPageText|body|column|main|shadow/i,
        :positiveRe => /article|storyPageText|body|content|entry|hentry|main|page|pagination|post|text|blog|story/i,
        :negativeRe => /combx|side|reactieboxTable|reactie|comment|com-|contact|foot|footer|footnote|masthead|media|meta|outbrain|promo|related|scroll|shoutbox|sidebar|sponsor|shopping|tags|tool|widget/i,
