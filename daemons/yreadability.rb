...
module Readability
  class Document
    ...
    REGEXES = {
        ...
        :negativeRe => /combx|side-|comment|reacties|reactie|comments|com-|contact|foot|footer|footnote|masthead|media|meta|outbrain|promo|related|scroll|shoutbox|sidebar|sponsor|shopping|tags|tool|widget/i,
